...
export default function ArchitectureSection() {
  ...
  return (
    <section
      ...
      className="h-screen w-full overflow-hidden bg-[#0a0a0a] border-b border-white/5 flex items-center"
    >
      <div className="pl-6 md:pl-24 flex items-center h-full">
        <div
          ref={horizontalScrollRef}
          className="flex gap-16 md:gap-32 flex-nowrap items-center w-max pr-24"
        >
          <div className="w-[80vw] md:w-[600px] shrink-0">
            <h2 className="text-6xl md:text-8xl font-bold tracking-tighter mb-4">
              Enterprise <br /> Grade <br /> Architecture.
            </h2>
            <p className="text-xl text-[#A1A1AA]">
              Scroll to explore how we keep your apps secure and available 24/7.
            </p>
          </div>
          ...
          <div className="w-[85vw] md:w-[500px] shrink-0 bg-[#111] border border-[#222] p-12 rounded-3xl">
            ...
            <p className="text-xl text-[#A1A1AA] leading-relaxed">
              Every deployment runs in strictly isolated containers. Built with
              maximum security to host your most critical applications without
              compromise.
            </p>
          </div>
          ...
          <div className="w-[85vw] md:w-[500px] shrink-0 bg-[#111] border border-[#222] p-12 rounded-3xl">
            ...
            <p className="text-xl text-[#A1A1AA] leading-relaxed">
              Versioned deployments allow for instantaneous, zero-downtime
              rollbacks. If a new build fails, you're always covered.
            </p>
          </div>
          ...
          <div className="w-[85vw] md:w-[500px] shrink-0 bg-[#111] border border-[#222] p-12 rounded-3xl">
            ...
            <p className="text-xl text-[#A1A1AA] leading-relaxed">
              Serve your static assets from our lightning-fast global edge
              network. Experience millisecond latency for users anywhere in the
              world.
            </p>
          </div>
          ...
          <div className="w-[85vw] md:w-[500px] shrink-0 bg-[#111] border border-[#222] p-12 rounded-3xl">
            ...
            <p className="text-xl text-[#A1A1AA] leading-relaxed">
              Just push to GitHub. We automatically detect changes, build your
              project, and deploy the new version without any manual
              configuration.
            </p>
          </div>
          ...
          <div className="w-[85vw] md:w-[500px] shrink-0 bg-[#111] border border-[#222] p-12 rounded-3xl">
            ...
            <p className="text-xl text-[#A1A1AA] leading-relaxed">
              Enterprise-grade DDoS mitigation is built-in by default. Your
              applications stay online and responsive even during massive
              traffic spikes or attacks.
            </p>
          </div>
        </div>
      </div>
