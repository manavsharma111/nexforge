...
export default function HeroSection() {
  ...
  return (
    <section
      ref={heroRef}
      className="relative w-full min-h-screen flex items-center justify-center pt-20 overflow-hidden border-b border-white/5"
    >
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-blue-500/10 rounded-full blur-[100px] pointer-events-none animate-pulse"
      ...
      <div className="z-10 max-w-7xl mx-auto w-full px-6 md:px-12 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        <div ref={heroTextRef} className="flex-1 flex flex-col items-start">
          ...
          <p className="text-lg md:text-xl text-[#A1A1AA] max-w-lg mb-10 leading-relaxed">
            Intuitive infrastructure to scale any app from your first user to
            your billionth. Push to GitHub, we handle the rest.
          </p>
