  ...
  return (
    <section ref={heroRef} className="relative w-full min-h-screen flex items-center justify-center pt-20 overflow-hidden border-b border-white/5">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="w-full h-full absolute top-0 left-0 opacity-[0.04]" style={{ backgroundImage: 'linear-gradient(to right, #ffffff 1px, transparent 1px), linear-gradient(to bottom, #ffffff 1px, transparent 1px)', backgroundSize: '4rem 4rem', maskImage: 'radial-gradient(ellipse 60% 50% at 50% 50%, #000 70%, transparent 100%)', WebkitMaskImage: 'radial-gradient(ellipse 60% 50% at 50% 50%, #000 70%, transparent 100%)' }}></div>
      </div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Hover fillColor="#A855F7" className="rounded-lg">
              <button
                ...
                className="bg-white text-black font-bold text-base px-8 py-4 flex items-center justify-center gap-3 outline-none"
              >
