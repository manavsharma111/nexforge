...
export default function AnalyticsSection() {
  ...
  return (
    <section
      ref={analyticsRef}
      className="py-32 px-6 md:px-12 max-w-7xl mx-auto border-b border-white/5 relative"
      ...
      <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
        ...
        <div className="flex-1 max-w-xl">
          ...
          <p className="text-xl text-[#A1A1AA] mb-10 leading-relaxed">
            Deep insights into your infrastructure. Live streaming logs,
            historical deployment tracking, and system-level analytics — all in
            one view.
          </p>
        ...
        <div className="flex-1 w-full" ref={dashboardCardRef}>
          <div className="bg-[#111] border border-[#333] rounded-2xl p-6 md:p-8 shadow-[0_30px_100px_-20px_rgba(168,85,247,0.2)] relative z-10">
            <div className="flex items-center justify-between mb-6 border-b border-[#222] pb-4">
              <span className="font-mono text-xs tracking-widest text-[#555] uppercase">
                System Metrics — Live
              </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-[#0a0a0a] border border-[#1a1a1a] p-5 rounded-xl">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-[10px] text-blue-400 font-mono bg-blue-400/10 px-2 py-0.5 rounded">
                    Deploying
                  </span>
                </div>
                <span className="text-[10px] text-[#555] uppercase font-mono block mb-2">
                  Memory Usage
                </span>
