...
const FEATURES = [
  {
    ...
    description:
      "Push to GitHub. We handle the rest. Your app goes live in seconds with zero-config builds.",
    icon: (
      <svg
        className="w-7 h-7"
        fill="none"
  ...
  },
  {
    title: "Global CDN",
    description:
      "Assets served from edge nodes worldwide for blazing-fast load times.",
    icon: (
      <svg
        className="w-7 h-7"
        fill="none"
    ...
    <section className="py-28 px-6 md:px-12 max-w-7xl mx-auto border-b border-white/5">
      <div className="text-center max-w-3xl mx-auto mb-16">
        ...
        <p className="text-xl text-[#A1A1AA]">
          A complete deployment platform with enterprise-grade features, all
