...
const FloatingChatbot = () => {
  ...
  const [chatHistory, setChatHistory] = useState([
    { sender: 'ai', text: 'Hi there I am NexAI, your AI assistant. How can I help you today?' }
  ])
          ...
          >
            ...
            <div className="bg-[#18181b] border-b border-[rgba(255,255,255,0.08)] p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-white font-bold text-lg leading-tight">NexAI</h3>
                ...
                >
                  <div className={`flex gap-2 max-w-[85%] ${msg.sender === 'user' ? 'flex-row-reverse' : 'flex-row'}`}>
                    <div className={`w-8 h-8 rounded-full shrink-0 flex items-center justify-center mt-1 ${
                      msg.sender === 'user' ? 'bg-[#27272a]' : 'bg-[#6366F1]/20'
                    }`}>
                      {msg.sender === 'user' ? (
                ...
                >
                  <div className="flex gap-2 max-w-[85%] flex-row">
                    ...
                    <div className="p-3 rounded-2xl bg-transparent rounded-tl-none border border-[#6366F1]/30 flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-400 italic">NexAI is thinking...</span>
                    </div>
                  </div>
                </motion.div>
              )}
